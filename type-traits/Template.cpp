...
TEST(Module1,UseTemplateForSimpleType)
{
...
{
	Storage<int, 20> storageWith20Size {1, 2, 3, 4, 5};
	ASSERT_EQ(storageWith20Size.GetSum(), 15);
}
//-------------------------------------------------------------------------------------------------
...
TEST(Module1,UseTemplateForUserType)
{
...
TEST(Module1,FullSpecializationTemplate)
{
...
TEST(Module1,PartialSpecializationTemplate)
{
	FooPartial<int> x(4);
	int v = 3;
	FooPartial<int*> y(&v);
